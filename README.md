...
# Marionette as an malicious application on OpenDaylight attacking Fat Tree Topology
...
1. Install Python3.9 and stable-baselines3
  ...
  python3.9 -m pip install 'stable-baselines3[extra]'
  ```
...
> (1) Run OpenDaylight
  ...
  sudo ./karaf
  ```
> (2) Install basic OpenFlow Plugins on OpenDaylight terminal ``  opendaylight-user@root>``:
  ```
